...
public class SessionService {
	...
	@Autowired
	ConvocationService topicService;
	...
	public Session find(Integer id) {
		...
		if(obj.get().getStatus() == SessionStatus.ABERTA.getCode() && (!DateUtil.isValidTime(obj.get().getTime()))) {
	...
	public Session insert(Session obj, Integer id) {
		...
		Convocation convocation = topicService.find(id);
